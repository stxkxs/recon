#!/usr/bin/env bash
#
# report.sh - HTML report generation for recond
#
...
[[ -n "${_RECOND_REPORT_LOADED:-}" ]] && return 0
_RECOND_REPORT_LOADED=1
...
<title>Recond Report - ${target}</title>
</head>
<body>
...
<div class="footer">
  Generated by recond v${version} &mdash; ${ended}
</div>
</body>
</html>
HTML_FOOTER
